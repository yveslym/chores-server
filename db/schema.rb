...
ActiveRecord::Schema.define(version: 20180208011332) do
  ...
  create_table "chores", force: :cascade do |t|
    ...
    t.bigint "group_id"
    t.bigint "{:foreign_key=>{:to_table=>:groups}}_id"
    t.index ["group_id"], name: "index_chores_on_group_id"
    t.index ["user_id"], name: "index_chores_on_user_id"
    t.index ["{:foreign_key=>{:to_table=>:groups}}_id"], name: "index_chores_on_{:foreign_key=>{:to_table=>:groups}}_id"
  end
